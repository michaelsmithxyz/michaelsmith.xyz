    ...
    <html lang="en" class="h-full">
      ...
      >
        <header className="mt-52 font-display">
          ...
          <h1 className="font-bold text-5xl sm:text-7xl mb-8 text-center">Michael Smith</h1>
          <nav>
            <ul
              className="
                list-none
        ...
        >
          ...
          <a className="underline" href="https://github.com/michaelsmithxyz/michaelsmith.xyz">
            Source on GitHub
          </a>
        </footer>
      </body>
